                                    ...
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-relaxed">
                                                <p>
                                                    Hệ thống ở đây thực sự rất tốt. Tôi đã nhiều lần đặt tiêm và được hướng dẫn cụ thể. Tôi rất hài lòng khi sử dụng dịch vụ ở đây !
                                                </p>
                                            </blockquote>
                                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                                                ...
                                                <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                                                    <img
                                                        src="https://cdn.eva.vn/upload/3-2023/images/2023-07-13/sao-nam-bat-khoc-tren-song-truc-tiep-70-tuoi-van-bi-con-trai-ep-kiem-tien-hop-dong-nhu-muon-lay-mang-lylapquan-1-1689217571-32-width660height660.jpg"
                                                        alt="user name"
                                                        title="user name"
                                                        width="48"
                                                        height="48"
                                ...
                                <div className="h-full overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200">
                                    <div className="relative p-6">
                                        <figure className="relative z-10">
                                            <blockquote className="p-6 text-lg leading-relaxed">
                                                <p>
                                                    Các vắc xin đa dạng. Khi gia đình tôi có em bé tôi thường xuyên tiêm ở đây. Tuy công việc nhiều nhưng tôi vẫn đặt lịch một cách nhanh chóng mà không cần bắt số như ở những trung tâm khác !
                                                </p>
                                            </blockquote>
                                            <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                                                <span
                                                ...
                                                <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                                                    <img
                                                        src="https://cherryradio.com.au/uploads/singer/avatar/2021/04/15043/1618372223_600.jpg"
                                                        alt="user name"
                                                        title="user name"
                                                        width="48"
                                                        height="48"
