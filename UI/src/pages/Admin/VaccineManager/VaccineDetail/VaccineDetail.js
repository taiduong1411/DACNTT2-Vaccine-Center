...
const VaccineDetailAdmin = () => {
    ...
    const getDataVaccineByCode = async () => {
        const res = await axiosCli().get(`admin/vaccine/${pro_code}`)
    ...
    const handleGeneralInformation = async () => {
        ...
        await axiosCli().post(`admin/update-detail/generalInformation/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
    ...
    const handleVaccineForPerson = async () => {
        ...
        await axiosCli().post(`admin/update-detail/vaccineForPerson/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
                    content: res.data.msg
    ...
    const handleVaccineSchedule = async () => {
        ...
        await axiosCli().post(`admin/update-detail/vaccineSchedule/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
                    content: res.data.msg
    ...
    const handleVaccineCondition = async () => {
        ...
        await axiosCli().post(`admin/update-detail/vaccineCondition/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
                    content: res.data.msg
    ...
    const handleVaccineDistance = async () => {
        ...
        await axiosCli().post(`admin/update-detail/vaccineDistance/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
                    content: res.data.msg
    ...
    const handleVaccineReact = async () => {
        ...
        await axiosCli().post(`admin/update-detail/vaccineReact/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
                    content: res.data.msg
    ...
    const handleVaccineStatus = async () => {
        ...
        await axiosCli().post(`admin/update-detail/vaccineStatus/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
                    content: res.data.msg
    ...
    const handleVaccineFaq = async () => {
        ...
        await axiosCli().post(`admin/update-detail/vaccineFaq/${pro_code}`, data).then(res => {
            if (res.status == 200) {
                messageApi.open({
                    type: 'success',
                    content: res.data.msg
...
export default VaccineDetailAdmin